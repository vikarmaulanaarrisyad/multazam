...
export function ImportExcelDialog({ open, onOpenChange, onSuccess }: ImportExcelDialogProps) {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const response = await importCategories(formData);
  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle>Import Kategori</DialogTitle>
          <DialogDescription>
            Tambahkan banyak kategori sekaligus menggunakan file Excel.
          </DialogDescription>
        </DialogHeader>
            ...
            <div className="flex items-start justify-between">
              <div>
                ...
                <p className="text-xs text-slate-500 mt-1">
                  Gunakan template ini untuk mengisi data kategori Anda agar sesuai dengan format sistem.
                </p>
              </div>
              <Button 
                type="button" 
